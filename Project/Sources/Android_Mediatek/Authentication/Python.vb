...
Namespace Mediatek.Authentication
    Public Class Python
        ...
        Public Shared DataTable As New DataTable()

        Public Shared Sub Exploits(cmd As String, worker As BackgroundWorker, ee As DoWorkEventArgs)
            Dim startInfo As New ProcessStartInfo(Pythonfile.Python, cmd) With {
                .CreateNoWindow = True,
        ...
        Public Shared Sub Command(cmd As String, worker As BackgroundWorker, ee As DoWorkEventArgs)
            ...
            Dim processStartInfo As New ProcessStartInfo(Pythonfile.Python, str & " " & cmd) With {
                .CreateNoWindow = True,
                .WindowStyle = ProcessWindowStyle.Hidden,
                .UseShellExecute = False,
                .Verb = "runas",
