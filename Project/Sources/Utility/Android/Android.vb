...
Public Class Android
    ...
    Public Shared Function AndroidUnpack(path As String, filepath As String, worker As BackgroundWorker, e As DoWorkEventArgs) As Object
        ImageUnpackInfo(String.Concat(New String() {"--unpack-bootimg", " ", path}), filepath, worker, e)
        Result = New Object()
        Return Result
    End Function

    Private Shared Sub ImageUnpackInfo(cmd As String, path As String, worker As BackgroundWorker, ee As DoWorkEventArgs)
        ...
        Dim startInfo As New ProcessStartInfo(Sourcefile.Andoidpath, cmd) With {
            .CreateNoWindow = True,
                ...
                AddHandler process.OutputDataReceived, Sub(sender As Object, e As DataReceivedEventArgs)
                                                           ...
                                                           If flag = True Then
                                                               ...
                                                               Using streamReader As New StreamReader(FilePath)
                                                                   ...
                                                                   While CSharpImpl.Assign(text, streamReader.ReadLine()) IsNot Nothing
                                                                   ...
                                                                   If array <> "" Then
                                                                       RichLogs(" platform" & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array.ToUpper(), Color.DarkOrchid, True, True)
                                                                   End If

                                                                   If array1 <> "" Then
                                                                       RichLogs(" cpu abi" & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array1, Color.DarkOrchid, True, True)
                                                                   End If

                                                                   If array2 <> "" Then
                                                                       RichLogs(" manufacturer" & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array2, Color.DarkOrchid, True, True)
                                                                   End If

                                                                   If array3 <> "" Then
                                                                       RichLogs(" board" & vbTab & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array3, Color.DarkOrchid, True, True)
                                                                   End If

                                                                   If array4 <> "" Then
                                                                       RichLogs(" name" & vbTab & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array4, Color.DarkOrchid, True, True)
                                                                   End If

                                                                   If array5 <> "" Then
                                                                       RichLogs(" brand" & vbTab & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array5, Color.DarkOrchid, True, True)
                                                                   End If

                                                                   If array6 <> "" Then
                                                                       RichLogs(" model" & vbTab & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array6, Color.DarkOrchid, True, True)
                                                                   End If

                                                                   If array7 <> "" Then
                                                                       RichLogs(" build id" & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array7, Color.DarkOrchid, True, True)
                                                                   End If

                                                                   If array8 <> "" Then
                                                                       RichLogs(" version" & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array8, Color.DarkOrchid, True, True)
                                                                   End If

                                                                   If array9 <> "" Then
                                                                       RichLogs(" build number" & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array9, Color.DarkOrchid, True, True)
                                                                   End If

                                                                   If array10 <> "" Then
                                                                       RichLogs(" build date" & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array10, Color.DarkOrchid, True, True)
                                                                   End If

                                                                   If array11 <> "" Then
                                                                       RichLogs(" security Patch" & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array11, Color.DarkOrchid, True, True)
                                                                   End If

                                                                   If array12 <> "" Then
                                                                       RichLogs(" description" & vbTab & ": ", Color.WhiteSmoke, True, False)
                                                                       RichLogs(array12, Color.DarkOrchid, True, True)
                                                                   End If
                                                               End Using
                                                           End If
                                                       End Sub
...
Public Class Sourcefile
    Public Shared Directorypath As String = "file/unpack"
