...
Public Class AdbTool
    ...
    Public adbclients As New AdbClient
    Public Sub New()
        SharedUI = Me
    End Sub
    ...
    Public Function adbcmd(AdbDotNetcmd As String, worker As BackgroundWorker, e As DoWorkEventArgs) As String
        ...
        If Not CheckRun() Then
            RichLogs("Server Not Running ...", Color.WhiteSmoke, True, True)
            RichLogs("Starting server : ", Color.WhiteSmoke, True, False)
        ...
        Try
            ...
            For i As Integer = 0 To 30
                ...
                Main.SharedUI.LabelTimer.Invoke(CType(Sub() Main.SharedUI.LabelTimer.Text = timeout, Action))
    ...
    Public Sub frp2(cmd As String)
        ...
        If Not CheckRun() Then
            ...
            RichLogs("Starting server : ", Color.Lime, True, False)
            AdbStartServer()
    ...
    Public Function CariAdbDevice() As Boolean
        ...
        If AdbDevices IsNot Nothing Then
            ...
            For Each device As Object In AdbDevices
                ...
                Main.SharedUI.comboUSB.Invoke(CType(Sub() Main.SharedUI.comboUSB.Text = $"ADB  [ SN : {device.SerialNumber.ToUpper()} ]", Action))

            Next
            SnAdb = AdbDevices(0).SerialNumber

            Console.WriteLine("Serial Number ADB : " & SnAdb)
            Return True
        End If
    ...
    Public Function CheckRun() As Boolean
        Try
            Dim Client As New TcpClient("127.0.0.1", 5037)
            Return True
