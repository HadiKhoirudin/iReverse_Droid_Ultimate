        ...
        For i As Integer = 0 To length Step 1
            ...
            While True
                If xmlReader.Read() Then
                    ...
                    End If
                    If xmlReader.NodeType = XmlNodeType.Element AndAlso Operators.CompareString(xmlReader.Name.ToLower(), "patch", False) = 0 Then
    ...
    Private Sub CheckBoxServer_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBoxServer.CheckedChanged
        ...
        Else
            Try
                ...
                Dim webRequest As WebRequest = WebRequest.Create(String.Concat(datatool, "/merks.php"))
    ...
    Private Sub ComboBoxEditBrand_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBoxEditBrand.SelectedIndexChanged
        ...
        If Flag Then
            Try
                ...
                TxtFlashLoader.Text = ""
                Dim webRequest As WebRequest = WebRequest.Create(String.Concat(datatool, ComboBoxEditBrand.Text.ToUpper(), ".txt"))
                webRequest.Method = "POST"
                webRequest.ContentType = "application/x-www-form-urlencoded"
                webRequest.Timeout = 10000
