...
Namespace Qualcomm.Qualcomm_list
    Class QcListport
        ...
        Public Shared Function QcDevicelists() As List(Of Info)
            Dim list As New List(Of Info)()

            Try
                Dim query As New WqlObjectQuery("SELECT * FROM Win32_PnPEntity WHERE ClassGuid=""{4d36e978-e325-11ce-bfc1-08002be10318}"" and Name LIKE '%Qualcomm HS-USB QDLoader 9008%'")
                Dim managementObjectSearcher As New ManagementObjectSearcher(query)
                ...
                For Each managementBaseObject As ManagementBaseObject In managementObjectSearcher.[Get]()
                    ...
                    If managementObject("Caption") IsNot Nothing AndAlso managementObject("Caption").ToString().Contains("9008") Then
